...
modbus_err_t modbus_register_event(modbus_event_t event, modbus_event_cb_t event_cb, void* event_ctx);
modbus_err_t modbus_unregister_event(cmodbus_event_t event);
